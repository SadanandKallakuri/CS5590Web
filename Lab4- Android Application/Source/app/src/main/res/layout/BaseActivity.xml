      ...
      RxPermissions.getInstance(this)
          ...
          .subscribe(new Action1<Boolean>() {
            ...
            public void call(Boolean granted) {
              if (!granted) {
                new AlertDialog.Builder(com.clarifai.android.starter.api.v2.activity.BaseActivity.this)
                    .setCancelable(false)
  ...
  protected List<IDrawerItem> drawerItems() {
    return Arrays.<IDrawerItem>asList(
        new PrimaryDrawerItem()
            ...
            .withOnDrawerItemClickListener(goToActivityListener(com.clarifai.android.starter.api.v2.activity.RecognizeConceptsActivity.class))
    );
  }
    ...
    return new Drawer.OnDrawerItemClickListener() {
      ...
      public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
        ...
        if (!drawerItem.isSelected()) {
          startActivity(new Intent(com.clarifai.android.starter.api.v2.activity.BaseActivity.this, activityClass).putExtra(INTENT_EXTRA_DRAWER_POSITION, position));
        }
        return true;
      }
    };
